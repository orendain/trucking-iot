...
rpm -Uvh $PROJ_DIR/resources/trucking-scripts/registry_2_1_0_0_164-0.0.1.2.1.0.0-164.el6.noarch.rpm
...
cp $PROJ_DIR/resources/nifi-registry-nar-0.0.1-SNAPSHOT.nar /usr/hdf/current/nifi/lib
